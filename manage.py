...
class Manager:
    ...
    def run(self):
        ...
        for item in to_be_added_Primary:
            print(item)
        print('Secondary Entries:')
        for item in to_be_added_Secondary:
            print(item)
        #print(to_be_added_Primary)
        #print(to_be_added_Secondary)
        ...
        if create_database:
            pass
        if create_table:
            self.connector.create_table('primary_', Standard.PrimaryEntry)
            self.connector.create_table('secondary_', Standard.SecondaryEntry)
